...
You can get a comparation on Excerciste 02 how much I have left to learn on react,
I got to abstract the custom hook but only half way, while Ken C. Dodds final example of hook (see /final/02.js)
it's a better abstraction of a custom hook abstraction. Totally a game changer
